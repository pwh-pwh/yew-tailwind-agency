...
pub fn Footer() -> Html {
    html! {
                                <footer class="grid gap-8 md:gap-0 text-gray-500 md:w-4/5 mx-auto mt-32 md:grid-cols-5">
                                    <div>
                                <img src={"https://yew.rs/img/logo.png"} alt="" class="w-8 h-8" />
                                <p>
                              ...
                              </div>
                              {
                                  (1..=3).map(|v|{
                                  html! {
                        <nav key={v} class="grid gap-2">
                                  <p class="text-lg text-black">{"产品介绍"}</p>
                                  <a href="">{"产品介绍1"}</a>
                                  <a href="">{"产品介绍2"}</a>
                                  <a href="">{"产品介绍3"}</a>
                                  <a href="">{"产品介绍4"}</a>
                    ...
                    <nav class="grid gap-2 content-start">
                            <p class="text-base text-black">{"注册"}</p>
                ...
                <div class="col-span-full mt-12 border-t py-9 flex flex-col gap-4 justify-between md:flex-row">
            <p>
                      {"由 "}
                      <a href="https://cruip.com/" class="text-blue-500">
                        {"Cruip"}
                      </a>
